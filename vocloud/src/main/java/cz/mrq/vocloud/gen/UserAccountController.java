...
public class UserAccountController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(bundle.getString("UserAccountCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(bundle.getString("UserAccountUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, bundle.getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(bundle.getString("UserAccountDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, bundle.getString("PersistenceErrorOccured"));
        }
    }
